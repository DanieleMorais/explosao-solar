...
export default async function Page({ params }) {
  ...
  if (!parDoSlug(par)) {
    ...
    if (inverso) permanentRedirect(withLang('pt', `/horoscopo/combinacao/${slugPar(inverso.a, inverso.b)}`))
    notFound()
  }
  return <CombinacaoView lang="pt" slug={par} />
}
