...
export default async function Page({ params }) {
  ...
  if (!parDoSlug(par)) {
    ...
    if (inverso) permanentRedirect(withLang('es', `/horoscopo/combinacao/${slugPar(inverso.a, inverso.b)}`))
    notFound()
  }
  return <CombinacaoView lang="es" slug={par} />
}
